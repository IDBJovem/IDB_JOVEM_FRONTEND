...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      ...
      {/* Mobile Menu Panel */}
      <div
        className={`fixed top-[70px] right-0 w-[85%] max-w-[320px] h-[calc(100vh-70px)] bg-white shadow-2xl z-50 lg:hidden transition-transform duration-300 ease-in-out flex flex-col ${
